import { AppWindow, Book, BookOpen, CalendarBlank, File, Graph, LinkBreak, Quotes } from "phosphor-react";
...
export function Software(props: Publicacao) {
                ...
                <div className="flex">
                    <div className="flex flex-col justify-center">
                        <div id="mudarCorDiv" className={` h-10 w-10 rounded-md mr-4 whitespace-nowrap flex items-center justify-center border-[1px] border-gray-300`}>
                            <AppWindow size={18} className="text-gray-400 whitespace-nowrap  w-10" />
