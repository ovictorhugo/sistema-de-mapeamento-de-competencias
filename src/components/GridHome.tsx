...
export function GridHome() {
    ...
    return  (
        ...
        <Link to={'/programas-graduacao'} className="rounded-xl transition-all hover:scale-[95%] flex gap-8 min-h-[300px] bg-[#F4FAEC] p-6 items-center justify-between">
            ...
            <p className="text-base text-gray-400">A plataforma também permite uma busca focada apenas no programa de pós-graduação, permitindo que se encontre os pesquisadores atuantes, assim como as métricas e os índices de produção.</p>
            </div>
        ...
        <Link to={'/indicators'} className="rounded-xl transition-all hover:scale-[95%] flex gap-8 min-h-[300px] bg-[#FFF5FB] p-6 items-center justify-between">
            ...
            <p className="text-base text-gray-400">Veja os dados analíticos sobre os artigos produzidos tendo a divisão por universidade ou pesquisador. Você também pode observar os estrato qualis e as produções técnicas </p>
            </div>
