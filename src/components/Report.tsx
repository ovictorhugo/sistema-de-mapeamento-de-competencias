                ...
                <div className="flex  gap-4 items-center justify-between relative bottom-0S">
                    <div className="flex gap-3">
                        <div className=" flex gap-3 flex-wrap">
                            ...
                            <div className="border-[1px] border-gray-300 py-2 flex px-4 text-gray-400 rounded-md text-xs font-medium gap-2 items-center"> <CurrencyCircleDollar size={16} className="text-gray-400" /> {props.financing}</div>
